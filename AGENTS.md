...
- profile 目录：`safe=7`、`development=169`、`diagnostic-readonly=138`、`legacy-full=201`、`development-workbench=136`、`business-readonly=18`、`operations-readonly=48`。
...
- 自动化基线：154 个 Jest suites、1455 个 tests（2026-09-18）。
