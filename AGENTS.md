...
- profile 目录：`safe=7`、`development=161`、`diagnostic-readonly=130`、`legacy-full=193`、`development-workbench=128`、`business-readonly=18`、`operations-readonly=50`。
...
- 自动化基线：146 个 Jest suites、1381 个 tests（2026-09-17）。
