...
- profile 目录：`safe=7`、`development=158`、`diagnostic-readonly=127`、`legacy-full=190`、`development-workbench=125`、`business-readonly=18`、`operations-readonly=47`。
...
- 自动化基线：145 个 Jest suites、1370 个 tests（2026-09-17）。
