...
- profile 目录：`safe=7`、`development=157`、`diagnostic-readonly=126`、`legacy-full=189`、`development-workbench=124`、`business-readonly=18`、`operations-readonly=46`。
...
- 自动化基线：144 个 Jest suites、1357 个 tests（2026-09-17）。
