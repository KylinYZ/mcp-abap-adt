...
- profile 目录：`safe=7`、`development=164`、`diagnostic-readonly=133`、`legacy-full=196`、`development-workbench=131`、`business-readonly=18`、`operations-readonly=48`。
...
- 自动化基线：153 个 Jest suites、1430 个 tests（2026-09-18）。
