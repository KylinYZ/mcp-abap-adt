...
- profile 目录：`safe=7`、`development=170`、`diagnostic-readonly=139`、`legacy-full=202`、`development-workbench=137`、`business-readonly=18`、`operations-readonly=48`。
...
- 自动化基线：156 个 Jest suites、1478 个 tests（2026-09-20）。
