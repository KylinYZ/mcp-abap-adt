...
/** Identifies cancellation without exposing Axios-specific error details. */
export const isRequestCancelled = (e: unknown): boolean =>
  (typeof e === "object" &&
    e !== null &&
    "code" in e &&
    e.code === REQUEST_CANCELLED_CODE) ||
  (isHttpError(e) && e.code === REQUEST_CANCELLED_CODE)
